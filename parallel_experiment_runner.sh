...
BENCHMARK_SCRIPT="run-experiment-cli-rq2-gpqa.py"  # Replace with the path to your Python benchmark script
MODELS=("google/gemma-2-27b-it" "microsoft/phi-4" "deepseek/deepseek-r1-distill-llama-8b" "google/gemini-2.0-flash-001" "qwen/qwen-2.5-72b-instruct" "qwen/qwq-32b" "meta-llama/llama-4-scout" "meta-llama/llama-4-maverick" "deepseek/deepseek-chat-v3-0324" "nf-gpt-4o" "nf-gpt-4o-mini" "o3-mini" "claude-3-5-sonnet-20241022" "claude-3-5-haiku-20241022")  # List of models to benchmark
COMMON_ARGS="--dataset-size 448 --n-samples 3 --experimental-run-version v21-short-form-bil-3-uni-3"  # Common arguments for all benchmark runs
