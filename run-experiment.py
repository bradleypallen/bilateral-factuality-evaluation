import argparse
from deprecated.factuality_evaluator import FactualityEvaluator
...
def main():
    ...
    # Evaluation
    filename = f'experiments/{args.run_version}/{args.model.split("/")[-1]}-{args.dataset}.json'
    model = FactualityEvaluator(args.model, temperature=0.1)
