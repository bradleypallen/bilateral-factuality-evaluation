...
BENCHMARK_SCRIPT="run-experiment.py"  # Replace with the path to your Python benchmark script
...
MODELS=("gpt-4o" "gpt-4o-mini")  # List of models to benchmark
COMMON_ARGS="--run_version v32 --dataset_samples 400 --n_repeated_samples 100"  # Common arguments for all benchmark runs
