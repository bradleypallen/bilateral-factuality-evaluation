...
from prompts import FACTUALITY_PROMPT_V8, VERIFICATION_PROMPT_V8, REFUTATION_PROMPT_V8
...
class UnilateralFactualityEvaluator(Model):
    ...
    def __init__(self, model_name, batch_size=1, temperature=0.1, factuality_prompt=FACTUALITY_PROMPT_V8):
